...
const SelectWalletModal = ({ }) => {
   ...
   const [AgreedToTermsOfServices, setAgreedToTermsOfServices] = useState<boolean | undefined>();
   ...
   return (
      ...
      >
         <div className="">
            ...
            ">
                  <div className="mt-4">
                     <Image src={"/logo.png"} alt="koryntia logo" className="" width={150} height={32} />
                  </div>
                  ...
                  <p className="w-[337px] text-[16px] text-dark not-italic font-normal font-inter leading-6 tracking-[0.08px]">
                     Connecting your wallet is like “logging in” to Web3. Select your wallet from the options to get
                     started.
                  </p>
