...
function Login() {
	...
	const [_, setAgreeToTermsOfServices] = useState<boolean>(false)
			...
			<div className="flex justify-center items-center h-screen">
                ...
                <button onClick={disconnectWallet}>Disconnect</button> */}
									...
									<div className="flex flex-col">
										...
										<span className="mb-1 text-sm font-medium text-gray-900 dark:text-white" style={{ lineBreak: 'anywhere' }}>
											{' '}
