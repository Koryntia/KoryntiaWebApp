...
//   const [AgreeToTermsOfServices, setAgreeToTermsOfServices] =
//     useState<boolean>(false);

//   const handleAgreement = (e: any) =>
//     setAgreeToTermsOfServices(e.target.checked);
...
//           <div
//             className={`bg-white md:w-[55%] w-full p-8 ${
//               window.innerWidth >= 768 ? "md:rounded-l-lg" : "rounded-t-lg"
//             }`}
//           >
...
//                 </div>
//                 <h2 className="text-2xl font-bold my-4 text-dark">
//                   Get Started
//                 </h2>
//                 <p className="text-darkText text-base mb-4">
//                   Select your wallet
//                 </p>
...
//                     className="text-dark text-sm ml-2"
//                   >
//                     Agree to{" "}
...
//           </div>
//           <div
//             className={`bg-appColor2 md:w-[45%] w-full
//                   p-6   ${
...
//                       className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-appColor1 rounded-sm"
//                     >
//                       Disconnect
//                     </button>
//                   </div>
